...
//                     </Text>
//                   </View>
//                   <View style={[styles.listboxMain, styles.listboxMainFlexBox]}>
//                     <View style={styles.listboxMainInner}>
...
//                     <Text style={[styles.occupation, styles.cleaningTypo]}>
//                       Sub-Category(Check if applicable)
//                     </Text>
//                   </View>
//                 </View>
//               </View>
  ...
  const handleSubmission = async () => {
    ...
    try {
      ...
      if (appForm3Docs.size === 1) {
        ...
        //     subcategories: mainCategoryData2[mainCategoryName],
        //   };
        //   await setDoc(appForm3DocRef, SubCategories);
        // }
