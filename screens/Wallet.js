...
//             <Text style={styles.php3200}>Php 3200</Text>
//             <Pressable
//               style={styles.button}
//               onPress={() => navigation.navigate("CashOutBalance")}
//             >
...
//           </Text>
//         </View>
//         <View style={styles.collectionParent}>
//           <Text style={[styles.collection, styles.php300Typo]}>Collection</Text>
//           <Text style={styles.oct}>08 Oct</Text>
//         </View>
