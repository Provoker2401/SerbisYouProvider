...
const NewBooking = ( {route} ) => {
  ...
  const { name, userBookingID, matchedBookingID, bookingIndex, providerCoordinates} = route.params;
        ...
        if (docSnapshot.exists()) {
          ...
          if (Array.isArray(bookingData.bookings) && bookingData.bookings.length > 0) {
            ...
            if (matchingBooking) {
              ...
              setCustomerUID(matchingBooking.customerUID);
          ...
          setIsLoading(false); // Set loading to false before fetching data
        } else {
        ...
        {/* <View style={styles.frameParent}> */}
          ...
          <View style={[styles.mapContainer]}>
            ...
            <TouchableOpacity style={styles.directionsButton} onPress={handleGetDirections}>
                <Image source={require('../assets/navigation-1-1.png')} style={styles.buttonIcon} />
            </TouchableOpacity>
          </View>
        {/* </View> */}
      {/* </View> */}
      ...
      >
        <View style={[styles.bodyInner, styles.frameFlexBox3]}>
          ...
          <View style={styles.frameParent}>
            ...
            <View
              style={[styles.bookingDetailsLabelParent, styles.bookingDetailsFlexBox]}
            >
              <View style={styles.bookingDetailsLabel}>
                <Text style={styles.bookingId}>Booking details</Text>
              </View>
              <View style={styles.container}>
                <Text style={styles.coordinatesText}>Latitude: {coordinates.latitude}</Text>
                <Text style={styles.coordinatesText}>Longitude: {coordinates.longitude}</Text>
              </View>
            ...
            >
              ...
              >
                ...
                <Animated.Image
                  style={[
                    styles.collapseArrowIcon, styles.frameWrapper7Layout, 
              ...
              {showContent && (
                ...
                <View style={[styles.subcategoriesFrame, styles.frameFlexBox1]}>
                  {/* <View
                    style={[
                  ...
                  >
                    <View style={styles.bookingDetailsLabel}>
                      <View style={styles.frameParent2}>
                        ...
                        <View style={styles.frameWrapper8}>
                          <View style={styles.bookingDetailsLabel}>
                            <Text
                              style={[
                                styles.toiletSystem,
                      ...
                      <View style={styles.frameParent3}>
                        ...
                        <View style={styles.frameWrapper16}>
                          <View style={styles.bookingDetailsLabel}>
                            <Text
                              style={[
                                styles.toiletSystem,
                  ...
                  {bookingServices.map((item, index) => {
                    ...
                    return (
                      <View
                        key={index}
                        style={[styles.dateAndTimeFrame4, styles.dateFrameFlexBox]}
                      >
