...
const EditService = () => {
 ...
 // const initialSelectedItems = [/* Your initial selected item IDs here */];
  const [prevSelectedItems, setPrevSelectedItems] = useState([]);
  const extractSelectedItems = (mainCategoryData) => {
    const selectedItems = [];
    for (const mainCategoryName in mainCategoryData) {
      const subCategoryData = mainCategoryData[mainCategoryName];
      for (const serviceName in subCategoryData) {
        const subCategories = subCategoryData[serviceName].SubCategories;
        selectedItems.push(...subCategories);
      }
    }
  ...
  const [
    subCategoryToMainCategoryMapping,
    setSubCategoryToMainCategoryMapping,
  ] = useState({});
  ...
  const catpetSittingItems = [
    {
      ...
      id: 1009,
      items: [
        { name: "Feeding and Watering", id: 1010 },
        { name: "Exercise and Playtime", id: 1011 },
        { name: "Potty Breaks", id: 1012 },
        { name: "Medication Administration", id: 1013 },
        { name: "Cage or Habitat Cleaning", id: 1014 },
        { name: "Specialized Care", id: 1015 },
        { name: "Flea and Tick Treatments", id: 1016 },
        { name: "Skin and Coat Treatments", id: 1017 },
      ],
    },
  ...
  const birdpetSittingItems = [
    {
      ...
      id: 1018,
      items: [
        { name: "Feeding and Watering", id: 1019 },
        { name: "Exercise and Playtime", id: 1020 },
        { name: "Medication Administration", id: 1021 },
        { name: "Cage or Habitat Cleaning", id: 1022 },
        { name: "Bird Massage", id: 1023 },
        { name: "Interactive Socialization", id: 1024 },
        { name: "Outdoor Exploration", id: 1025 },
      ],
    },
  ];
  ...
  const rabbitpetSittingItems = [
    {
      ...
      id: 1026,
      items: [
        { name: "Feeding and Watering", id: 1027 },
        { name: "Exercise and Playtime", id: 1028 },
        { name: "Litter Box Maintenance", id: 1029 },
        { name: "Medication Administration", id: 1030 },
        { name: "Cage or Habitat Cleaning", id: 1031 },
        { name: "Specialized Care", id: 1032 },
        { name: "Skin and Fur Treatments", id: 1033 },
      ],
    },
  ];
