...
const PerformTheServiceHeader = ({ style }) => {
  ...
  return (
    <SafeAreaView style={[styles.header, style]}>
      <View style={[styles.view, styles.viewFlexBox]}>
        ...
        <View style={[styles.performTheServiceWrapper, styles.viewFlexBox]}>
          <Text style={styles.performTheService}>Perform the service</Text>
        </View>
      </View>
    </SafeAreaView>
  );
...
export default PerformTheServiceHeader;
