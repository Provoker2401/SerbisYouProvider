  ...
  return (
    <SafeAreaView style={[styles.header, style]}>
      <View style={styles.view}>
        ...
        <View style={[styles.frame, styles.locationWrapperFlexBox12]}>
          <Pressable style={styles.locationBtn}>
            <View
              style={[
                styles.currentLocationWrapper,
                styles.locationWrapperFlexBox12,
              ]}
            >
              <Text
                style={[styles.currentLocation, styles.currentLocationFlexBox6]}
              >
                Current Location
              </Text>
            </View>
            <View
              style={[styles.locationBtn1, styles.locationWrapperFlexBox12]}
            >
              <View
                style={[
              ...
              >
                <Text
                  style={[
                    ...
                    styles.currentLocationFlexBox6,
                  ]}
                >
                  Talamban, Cebu City
                </Text>
...
const styles = StyleSheet.create({
  ...
  locationWrapperFlexBox12: {
    justifyContent: "flex-end",
    alignItems: "center",
  },
  currentLocationFlexBox6: {
    textAlign: "right",
    flex: 1,
    color: Color.m3White,
  },
