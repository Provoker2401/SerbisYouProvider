    ...
    <SafeAreaView style={[styles.header, style]}>
      <View style={styles.view}>
        ...
        <View style={styles.frameParent}>
          <View
            style={[styles.serbisyouWrapper, styles.locationWrapperFlexBox1]}
          >
            <Text style={[styles.serbisyou, styles.providerFlexBox]}>
              SerbisYou
            </Text>
          </View>
          <View
            style={[styles.providerWrapper, styles.locationWrapperFlexBox1]}
          >
            <Text style={[styles.provider, styles.providerFlexBox]}>
              Provider
            </Text>
          </View>
        </View>
        <View style={[styles.frame, styles.locationWrapperFlexBox]}>
          <Pressable style={styles.locationBtn}>
            ...
            >
              ...
              <View
                style={[styles.locationBtnInner, styles.locationWrapperFlexBox]}
              >
                <Image
